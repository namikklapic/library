...
public class PanelStudent extends JFrame {
	public PanelStudent(Student s){
		...
		// Disappearing panel items -- BEGIN
			// Lines -- BEGIN
				...
				lineBooks.setBounds(13, 325, 74, 3);
				...
				lineLoans.setBounds(13, 225, 141, 3);
				...
				// Buttons -- BEGIN
						...
						lblBooks.setBounds(13, 278, 154, 80);
						...
						lblLoans_1.setBounds(12, 178, 154, 80);
	...
	// Right panel minimize and exit buttons -- END
		...
		rezervacijeMenu.add(rezervacijePregled.getMenuItem(panel));
		...
		*/
		...
		File profilePicture = new File(PanelBibliotekar.class.getResource("/swing/profileImages/").toString().substring(6) + s.getKorisnik().getSifraKorisnika() + ".jpg");
		
		boolean exists = profilePicture.exists();
		
		if(exists == true) 
		{
			ImageIcon icon = new ImageIcon(PanelBibliotekar.class.getResource("/swing/profileImages/" + s.getKorisnik().getSifraKorisnika()	+ ".jpg"));
			...
			public void mouseClicked(MouseEvent arg0) {
                ...
                try {
                    if (response == JFileChooser.APPROVE_OPTION) {
                        ...
                        File target = new File(PanelBibliotekar.class.getResource("/swing/profileImages/").toString().substring(6) + s.getKorisnik().getSifraKorisnika() + ".jpg");
		...
		JLabel lblNameEntry = new JLabel(s.getKorisnik().getImeKorisnika());
		...
		JLabel lblSurnameEntry = new JLabel(s.getKorisnik().getPrezimeKorisnika());
		...
		JLabel lblNegPtsEntry = new JLabel(String.valueOf(s.getKorisnik().getBrojNegativnihBodova()));
		...
		panelLoans.setLayout(null);
			...
			lineViewReservations.setBounds(473, 375, 332, 3);
			...
			JLabel lblViewReservations = new JLabel("View my book reservations");
		...
		// Overall panel items -- BEGIN
					// Buttons -- BEGIN
							...
							lblLoans.setBounds(0, 163, 78, 110);
							panel.add(lblLoans);
							...
							lblBooks_1.setBounds(0, 263, 78, 110);
